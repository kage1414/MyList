...
func (iq *ItemQuery) QueryUser() *UserQuery {
...
func (iq *ItemQuery) WithUser(opts ...func(*UserQuery)) *ItemQuery {
	query := (&UserClient{config: iq.config}).Query()
...
func (iq *ItemQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Item, init func(*Item), assign func(*Item, *User)) error {
